...
<div
    class="w-full bw-alert animate__animated animate__fadeIn rounded-md flex p-3 {{ $color[$shade][$type] }} {{ $color[$shade][$type . '_text'] }} {{ $class }}">
    @if ($show_icon)
        <div class="pt-[1px]">
    ...
    @endif
    <div class="grow pl-2 pr-5" id="{{ $containerId }}">{{ $slot }}</div>
    @if ($show_close_icon)
