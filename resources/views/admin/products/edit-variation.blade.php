    ...
    <form method="POST" action="{{ route('variations.update', $variation->id) }}" enctype="multipart/form-data">
        ...
        <div class="row bg-white p-2">
            <div class="col-12 col-md-4">
                ...
                <p>{{ __('app.vat') }}: <b>{{ $variation->vat_ratio }}%</b></p>
                <p>{{ __('app.otv') }}: <b>{{ $variation->otv_ratio }}%</b></p>
                <p>{{ __('app.created-at') }}: <b>{{ $variation->created_at }}</b></p>
                <p>{{ __('app.updated-at') }}: <b>{{ $variation->updated_at }}</b></p>
            </div>
